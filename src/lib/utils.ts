...
/** A category is closed only when staff switched it off in the admin panel —
 *  there is no automatic weekday schedule any more. */
export function categoryClosedNow(closed: boolean): boolean {
  return closed;
}
