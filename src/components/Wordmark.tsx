...
export function Wordmark({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* C */}
      <path d="M358 9.7C352.8 4.7 346.2 2 338.7 2C323.7 2 312 13.2 312 26C312 39.1 323.7 50 338.7 50C346.1 50 352.8 47.3 358 42.3L352.8 36.5C349 40.1 344.2 42 339 42C328.3 42 320.3 35.2 320.3 26C320.3 16.9 328.3 10 339 10C344.2 10 349 11.9 352.8 15.5L358 9.7Z" />
